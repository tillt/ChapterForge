...
build_stts_img(const std::vector<ChapterImageSample> &samples,
               uint32_t timescale) {
...
// -----------------------------------------------------------------------------
static std::unique_ptr<Atom>
build_stsc_img(const std::vector<uint32_t> &chunk_plan) {
...
// -----------------------------------------------------------------------------
static std::unique_ptr<Atom>
build_stsz_img(const std::vector<ChapterImageSample> &samples) {
...
build_image_stbl(const std::vector<ChapterImageSample> &samples,
  ...
  uint32_t chunk_count = chunk_plan.empty()
